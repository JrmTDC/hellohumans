  ...
  <div class="ml-[-20px] mr-[-20px] pt-[12px] mt-[20px]">
    ...
    <section class="mr-[20px] ml-[20px]">
      <div>
        ...
        <p class="mb-0 mt-[8px] font-normal text-[14px] leading-[18px] tracking-[-0.01em] text-[#647491]">
          Modifiez le nom de votre Agent IA et ajoutez la description de votre entreprise.
        </p>
      </div>
    ...
    <section class="mr-[20px] ml-[20px] border-t border-t-[rgb(226,232,239)] mt-[12px]">
      <div class="pt-[32px]">
        ...
        <p class="mb-0 mt-[8px] font-normal text-[14px] leading-[18px] tracking-[-0.01em] text-[#647491]">
          Personnalisez le style des réponses
        </p>
      </div>
      <div class="pt-[20px] pb-[20px]">
          ...
          <div class="mt-[20px] flex flex-row justify-start items-start">
            <label for="" class="flex-[1_0_145px] min-w-[145px] max-w-[min(180px,12vw)] inline-block font-normal">
              <div class="flex flex-col justify-start items-[normal]">
                ...
                <p class="mt-[4px] font-normal text-[12px] leading-[16px] tracking-[-0.01em] text-[rgb(100,116,145)]">
                  L'Agent IA ajoute des liens « En savoir plus » vers des sources externes dans ses réponses, lorsque ces sources sont disponibles.
                </p>
              </div>
            </label>
...
const handleStyleChange = (option) => {
  ...
  // Ici, vous pourriez ajouter une logique pour sauvegarder le style sélectionné
}
</script>
