<template>
     ...
     >
          <div class="flex flex-col justify-start items-[normal] border border-[#e2e8ef] rounded-[12px]" :class="[ index >= 1 ? 'mt-[16px]' : '' ]">
               ...
               <div
                    v-if="module.multipleChoice && checked"
                    class="flex flex-col justify-start items-[normal] px-[24px] pb-[24px] pt-0"
               >
                    <div class="flex flex-row justify-start items-center">
                         <p
                              class="mt-0 mb-0 font-normal text-[14px] leading-[18px] tracking-[-0.01em] text-[#080f1a]"
                         >
                    ...
                    <div class="flex flex-col justify-start items-[normal]">
                         <div class="mb-0 text-left relative w-full">
                              <select
                                   class="block w-full h-[34px] text-[14px] leading-[18px] border border-[#d3dbe5] rounded-[6px] px-[8px]"
     ...
     <div
          v-else
          class="flex flex-col justify-start items-[normal] border border-[#e2e8ef] rounded-[12px]"
          ...
          <div class="flex flex-col justify-start items-[normal] p-[20px]">
               <div class="flex flex-row justify-start items-center">
                    <div class="flex flex-col mr-auto">
                         <label
                              v-if="!checked"
                              class="relative inline-block align-top rounded-[17px] border border-[#d3dbe5] bg-[#f5f7f9] cursor-pointer w-[36px] h-[22px]"
                         >
                              <input
                                   type="checkbox"
                                   role="switch"
                              ...
                              />
                              <div
                                   class="absolute left-[1px] top-[1px] bottom-[1px] w-[18px] rounded-full bg-white transition-[left,transform] duration-200 ease-in-out shadow-[0px_2px_8px_rgba(0,20,51,0.28)]"
                              ></div>
                         </label>

                         <label
                              v-else
                              class="relative inline-block align-top rounded-[17px] border border-[#0566ff] bg-[#0566ff] cursor-pointer w-[36px] h-[22px] shadow-[inset_0px_0px_0px_11px_#0566ff]"
                         >
                              <input
                                   type="checkbox"
                                   role="switch"
                              ...
                              />
                              <div
                                   class="absolute left-[calc(100%-1px)] top-[1px] bottom-[1px] w-[18px] rounded-full bg-white transition-[left,transform] duration-200 ease-in-out shadow-[0px_2px_8px_rgba(0,20,51,0.28)] translate-x-[-100%] translate-y-0"
                              ></div>
                         </label>
                         <span class="block w-[12px] h-[12px]"></span>
                    </div>
                    ...
                    <div class="flex flex-col self-end">
                         <p
                              v-if="module.multipleChoice && !checked"
                              class="mt-0 mb-0 font-normal text-[11px] leading-[14px] tracking-[-0.01em] text-right text-[#647491]"
                         >
                              À partir de
                         </p>
                         <span class="block w-[2px] h-[2px]"></span>
               ...
               <div class="flex flex-row justify-start items-center">
                    <div class="flex flex-col justify-start items-[normal] flex-grow">
                         <h2
                              class="mt-0 mb-0 font-medium text-[18px] leading-[24px] tracking-[-0.01em] text-[#080f1a]"
                         >
                              {{ module.name }}
                         </h2>
                         <p
                              class="mt-[8px] mb-0 font-normal text-[14px] leading-[18px] tracking-[-0.01em] text-[#647491]"
                         >
                              {{ module.description }}
                         </p>
                    </div>
            ...
            <span>
              <span
                   class="h-auto relative text-[24px] leading-[31px] tracking-[-0.01em] text-[#080f1a] font-medium"
              >
                {{ displayedPrice }}<span
                   class="text-[24px] leading-[31px] font-medium"
              >€</span
              >
              </span>
              <span
                   class="text-[12px] leading-[16px] tracking-[-0.01em] text-[#080f1a] font-medium"
              >{{ billingCycle === 'monthly' ? '/mois' : '/an' }}</span
              >
            </span>
                         </div>
                    </div>
