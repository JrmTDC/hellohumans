          ...
          <div class="flex h-full w-full">
               ...
               <div class="flex flex-col text-left ml-[25px]">
                    ...
                    <div class = "overflow-y-auto max-h-[414px] mt-[15px] mb-[15px]">
                         ...
                         <div class="mt-[15px]">
                              <h2 class="text-[16px] text-black font-semibold">Description</h2>
                         ...
                         <div class="mt-[20px]">
                              <h3 class="inline font-semibold text-[16px] text-[#000]">Départ :</h3>
                              <div class="inline ml-[10px] text-[14px] text-[#606060]">Saint-Ilpize</div>
                         </div>
                         <div class="mt-[10px]">
                              <h3 class="inline font-semibold text-[16px] text-[#000]">Arrivée :</h3>
                              <div class="inline ml-[10px] text-[14px] text-[#606060]">Saint-Ilpize</div>
                         </div>
                         <div class="mt-[10px]">
                              <h3 class="inline font-semibold text-[16px] text-[#000]">Communes traversées :</h3>
                              <div class="inline ml-[10px] text-[14px] text-[#606060]">Saint-Ilpize</div>
                         </div>
                         ...
                         <div class="mt-[20px]">
                              <h3 class="text-[16px] text-[#000] font-semibold">Recommandations</h3>
                         ...
                         <div class="mt-[20px] font-semibold text-[16px] text-[#000]">
                              <h3>Accès routiers et parkings</h3>
                         </div>
                         <div class="mt-[3px] text-[14px] text-[#606060]">
               ...
               <div class="flex flex-col text-left">
                    <div class=" mr-[10px]">
                         <NuxtLink
                              to="/files/rando/pr288-aux-portes-du-chateau.pdf"
                              target="_blank"
