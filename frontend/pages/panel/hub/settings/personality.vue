                              ...
                              <div class="p-[24px_28px] border border-[#e2e8ef] bg-white rounded-[16px] min-h-[calc(100%-12px)] flex-[1_1_0%]">
                                   ...
                                   <div class="mt-[20px] flex items-center relative flex-row-reverse flex-wrap justify-start">
                                        <div class="flex flex-row justify-start items-center flex-[1_1_0%] border-b border-b-[#e2e8ef]">
                                             <NuxtLink
                                                 to="/panel/hub/settings/general"
                                                 class="relative px-[12px] pt-[16px] pb-[20px] text-[16px] transition-colors duration-200"
                                                 :class="{
                      'text-[#0566ff] border-b-[3px] border-b-[#0566ff]': $route.path.includes('/general') || $route.path === '/panel/hub/settings',
                      'text-[#080f1a] hover:text-[#0566ff]': !$route.path.includes('/general') && $route.path !== '/panel/hub/settings'
                    }"
                                             >
                                             ...
                                             <NuxtLink to="/panel/hub/settings/personality" class="relative px-[12px] pt-[16px] pb-[20px] text-[16px] transition-colors duration-200" :class="{'text-[#0566ff] border-b-[3px] border-b-[#0566ff]': $route.path.includes('/personality'),'text-[#080f1a] hover:text-[#0566ff]': !$route.path.includes('/personality')}">
                                                  <div class="flex flex-row justify-center items-center">
