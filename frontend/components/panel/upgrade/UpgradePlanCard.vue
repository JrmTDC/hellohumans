<template>
     <div class=" cursor-pointer" @click="handleSelectPlan">
          <!-- Haut : Titre, badges -->
          <div class="bg-white px-[20px] pt-[30px] pb-[2px] text-center flex flex-col justify-center items-start relative [border-radius:12px_12px_0px_0px]" :class="[orderClass(1), borderTopClasses]">
          ...
          <!-- Prix -->
          <div :class="[ 'bg-white px-[20px] pb-[16px] text-center flex flex-col justify-center items-start', borderClasses, orderClass(3) ]">
               <span>
          ...
          <div v-for="(feature, idx) in plan.includedFeatures" :key="idx" :class="[ 'bg-white px-[20px] pb-[16px] text-center flex flex-col justify-center items-start', borderClasses, `order-[${6000 + props.index + 1 + idx}]` ]">
               <div class="flex flex-row justify-start items-center">
          ...
          <!-- Bas arrondi -->
          <div class="bg-white px-[20px] pb-[18px] text-center flex flex-col justify-center items-start mb-[20px] [border-radius:0px_0px_12px_12px]" :class="[orderClass(7),borderBottomClasses]">
          </div>
     </div>
</template>
